...
Combine ES ranking and neural ranking
"""
import os
import sys
import argparse
...
def run():
    ...
    output = open(f'output/{exp_name}_es_w_{es_score_weight}_es_limit_{es_output_limit}_recall_20.csv', 'w')
    total_recall = 0
    total_n_dcg = 0
    ...
    for example in tqdm(examples):
        ...
        scores = [str(article_score['combined_score']) for article_score in articles_scores[:20]]
